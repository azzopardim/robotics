 ...
 *   
 *   DEBUG NOTE: Teensy will not run if disconnected from serial with any debug flag set, as these all
...
const byte debug6 = 1;            //serial communication output/response and serial terminal commands
const byte debug7 = 1;            //uss sensors
